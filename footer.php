  ...
  <div class="gradient-shape is-bottom">
    ...
    <div class="footer-contents">
      ...
      <div class="footer-social">
        <a href="/" target=”_blank”><button class="btn-secondary">LinkedIn</button></a>
    ...
    <div class="container"">
      <div class="menu">
        <div class="menu-links">
          <a href="http://localhost/wordpress-portfolio/index.php/recent/"><h3>Recent Work</h3></a>
          <a href="http://localhost/wordpress-portfolio/index.php/sandbox/"><h3>Sandbox</h3></a>
          <a href="http://localhost/wordpress-portfolio/index.php/design/"><h3>Design</h3></a>
          <a href="http://localhost/wordpress-portfolio/index.php/roles/"><h3>Roles</h3></a>
        </div>
        <div class="menu-info">
